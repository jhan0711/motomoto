...
- Para usar la aplicación hay que registrarse con nombre, celular y correo
  reales. La persona es responsable de la veracidad de esos datos.
- La persona es responsable de mantener en secreto su contraseña y de toda
  actividad realizada desde su cuenta.
- Una cuenta es personal e intransferible.
- El registro está reservado a personas mayores de edad. Un menor solo puede usar
  el servicio a través de la cuenta de su representante legal.
...
5. Al terminar, el pasajero paga en efectivo y ambas partes pueden calificar.
...
## 6. Conducta de las personas usuarias

Queda prohibido:

- Dar datos falsos o suplantar a otra persona.
- Usar la aplicación para actividades ilegales o para transportar bienes
  prohibidos.
- Agredir, amenazar, discriminar o acosar a la contraparte.
- Manipular las calificaciones o el funcionamiento de la aplicación.
- Usar la aplicación fuera del municipio de Amalfi o para fines distintos del
  transporte descrito.

El incumplimiento puede llevar a la **suspensión o el bloqueo** de la cuenta, sin
